...
# Modified Schema with addressDetails struct
schema = StructType([
...
def process_complex_data(first_name: pd.Series, last_name: pd.Series, address_details: pd.Series, contact_info: pd.Series) -> pd.DataFrame:
    def process_row(first_name, last_name, address_details, contact_info):
        full_name = f"{first_name} {last_name}"
        
        # Parse the address_details string into a dictionary containing the list of addresses
    ...
    result = [process_row(fn, ln, addr, ci) for fn, ln, addr, ci in zip(first_name, last_name, address_details, contact_info)]
